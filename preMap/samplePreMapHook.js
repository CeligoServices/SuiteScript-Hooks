 ...
 * @param  {[type]} options The data sent to the hook.  See SampleOptionsData.json for format
 ...
 * @param  {[type]} options  Data passed into the PreMap hook
 * @param  [type] response The object that is passed on to the mappings
 * @return null
 */
var logOptions = function(options, response){
	nlapiLogExecution('AUDIT', 'Options', JSON.stringify(options));
};