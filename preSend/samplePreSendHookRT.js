 ...
 * 
 * @param {Object}
 *            options The data sent to the hook. See SamplePreSendDataRT.json
 *            for format
 * @return {Object} response containing the data sent to integrator.io
 */
var samplePreSendHookRT = function(options) {
	 ...
	 */
	response.data.push(JSON.parse(JSON.stringify(options.data)));
